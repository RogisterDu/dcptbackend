...
app.register_blueprint(visitor_blueprint, url_prefix='/api')
app.register_blueprint(patient_blueprint, url_prefix='/api')
app.register_blueprint(medical_blueprint, url_prefix='/api')
app.register_blueprint(charge_blueprint, url_prefix='/api')
app.register_blueprint(fee_blueprint, url_prefix='/api')
app.register_blueprint(reserve_blueprint, url_prefix='/api')
app.register_blueprint(account_blueprint, url_prefix='/api')
app.register_blueprint(template_blueprint, url_prefix='/api')
app.register_blueprint(dicom_blueprint, url_prefix='/api')
